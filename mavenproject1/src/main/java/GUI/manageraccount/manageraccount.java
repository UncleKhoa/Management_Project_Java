 ...
 * @author ADMIN
 */
public class manageraccount extends javax.swing.JPanel {
    ...
    /**
     * Creates new form manageraccount1
     */
...
//         table.getColumnModel().getColumn(5).setCellRenderer(new TableActionCellRender());
        ...
        jComboBox1.setLabeText("Hoạt động");
        jComboBox1.addItem("unlock");
        jComboBox1.addItem("locked");
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã nhân viên", "Username", "Password", "Gmail", "Trạng thái"
            }
        ) {
    ...
    private Model.Combobox jComboBox1;
