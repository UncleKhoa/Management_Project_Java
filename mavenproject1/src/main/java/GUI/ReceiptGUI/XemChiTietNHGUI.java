...
public class XemChiTietNHGUI extends javax.swing.JFrame {
    ...
    /**
     * Creates new form XemChiTietNHGUI
     */
    public XemChiTietNHGUI() {
        initComponents();
    }
    
    public XemChiTietNHGUI(importDTO nh, String staffname) {
        initComponents();
        setLocationRelativeTo(null);
        this.nh = nh;
        this.staffName = staffname;
        JTableHeader header = tblImportDetail.getTableHeader();
        header.setDefaultRenderer(new CustomHeaderRenderer());
        imBUS = new import_detailBUS();
        list = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        txtImportID.setPreferredSize(new java.awt.Dimension(73, 35));
        txtImportID.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtImportIDActionPerformed(evt);
            }
        });
        jPanel1.add(txtImportID, new org.netbeans.lib.awtextra.AbsoluteConstraints(7, 99, 180, -1));
        ...
        lblMaNCC.setFont(new java.awt.Font("Segoe UI Semibold", 0, 13)); // NOI18N
        jPanel1.add(lblMaNCC, new org.netbeans.lib.awtextra.AbsoluteConstraints(333, 7, 80, 33));
        ...
        jPanel1.add(lblStaffName, new org.netbeans.lib.awtextra.AbsoluteConstraints(601, 7, 89, 33));
    ...
    public void viewInfo(){
        ...
        txtImportID.setText(nh.getImporID());
        txtCreatedDate.setText(Date_String(nh.getCreatedDate()));
        txtTotal.setText(""+formatMoney(ConvertDoubleToInt(nh.getTotal())));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XemChiTietNHGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new XemChiTietNHGUI().setVisible(true);
            }
        });
    }
